...
/**
 * @since 2019.10.22 13:38
 * @author subkjh autometic create by subkjh.dao
 *
 */

@SuppressWarnings("serial")
@FxTable(name = "OMN25102", comment = "광레벨감시이력")
public class OMN25102 implements Serializable {
	...
	@FxColumn(name = "OLINE_USG_CD", size = 2, nullable = true, comment = "광회선용도코드")
	private String olineUsgCd;

	@FxColumn(name = "CURR_SPAN_LOSS_VAL", size = 7, nullable = true, comment = "현재SPAN손실값")
	private float currSpanLossVal;

	@FxColumn(name = "BAS_SPAN_LOSS_VAL", size = 7, nullable = true, comment = "기본SPAN손실값")
	private float basSpanLossVal;
	 ...
	 *            광회선용도코드
	 */
	public void setOlineUsgCd(String olineUsgCd) {
		this.olineUsgCd = olineUsgCd;
	}
	 ...
	 * @return 현재SPAN손실값
	 */
	public float getCurrSpanLossVal() {
		return currSpanLossVal;
	}

	/**
	 * 현재SPAN손실값
	 *
	 * @param currSpanLossVal
	 *            현재SPAN손실값
	 */
	public void setCurrSpanLossVal(float currSpanLossVal) {
		this.currSpanLossVal = currSpanLossVal;
	}
	 ...
	 * @return 기본SPAN손실값
	 */
	public float getBasSpanLossVal() {
		return basSpanLossVal;
	}

	/**
	 * 기본SPAN손실값
	 *
	 * @param basSpanLossVal
	 *            기본SPAN손실값
	 */
	public void setBasSpanLossVal(float basSpanLossVal) {
		this.basSpanLossVal = basSpanLossVal;
	}
}
